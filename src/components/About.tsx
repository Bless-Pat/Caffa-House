        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div className="order-2 md:order-1">
            ...
            <p className="text-lg mb-6 text-muted-foreground">
              At CaFFa House, we believe in creating spaces that inspire
              creativity, productivity, and community connection. Our name is
              coined from "Community aFFair" - a testament to our mission of
              influencing and inspiring through creativity and lifestyle.
            </p>
            ...
            <div className="mb-8 p-6 bg-primary/5 rounded-xl border border-primary/10">
              ...
              <p className="text-muted-foreground">
                To provide a multifunctional space where young Africans can
                express themselves, connect with like-minded individuals, and
                experience exceptional services that enhance their lifestyle.
              </p>
            </div>
